...
[Note: Avoid extracting in some sub-folder as HomePage.html may give Error in such case. Simply click 'Extract Here' and extract to above path directly.]

To run project, run Wamp and run 'HomePage.html' file.
If 'HomePage.html' gives error, its most probably of the path of the file.
In such case, directly run 'login.php' in browser by using the following address:
